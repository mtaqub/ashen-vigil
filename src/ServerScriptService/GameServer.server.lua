...
-- World geometry, lighting, and ambience live in ArenaBuilder; this script
-- owns gameplay state and logic only. Build() (re)creates AshenVigilArena
-- and returns the folders enemies/gems/effects get parented into.
local worldFolders = ArenaBuilder.Build()
local enemiesFolder = worldFolders.enemiesFolder
local gemsFolder = worldFolders.gemsFolder
local effectsFolder = worldFolders.effectsFolder
